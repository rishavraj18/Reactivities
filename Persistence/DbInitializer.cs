...
namespace Persistence;
    public class DbInitializer
    {
        public static async Task SeedData(AppDbContext context)
        {
            ...
            context.Activities.AddRange(activities); //Tracking in memory
            await context.SaveChangesAsync();  //executing query in database and add all the activities from above line
        }
    }
